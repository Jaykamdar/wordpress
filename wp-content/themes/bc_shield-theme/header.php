				...
				<div class="row">
					...
					<nav class="navbar navbar-default ow-navigation">
						<div class="navbar-header">
							...
							<a href="index.html" class="navbar-brand"><img src="images/logo-white.png" alt="Logo" />Shield theme</a>
						</div>
						<div class="menu-icon">
							<div class="cart">							
										...
										<li>
											<div class="dropdown-box col-md-3">
												<ul>
													...
													<li><a href="portfolio_mansory_2_column_sidebar_left.html" title="mansory 3 column sidebar left">mansory 2 column sidebar left</a></li>
